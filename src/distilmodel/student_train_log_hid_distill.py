...
def train_with_log_hid_distill(student_model, iterator, optimizer, scheduler, criterion, teacher_model,
    ...
    for i, batch in enumerate(iterator):
        ...
        full_loss = (logit_loss + hidden_loss) / (float(len(layer_config["student_to_teacher_layer"])) + 1)
...
if __name__ == '__main__':
    ...
    for epoch in trange(args.epochs, desc="Epoch"):
        train_loss, distill_loss, train_acc, wall_time = train_with_log_hid_distill(bert_student_model,

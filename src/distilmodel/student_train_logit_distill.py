...
def train_with_logit_distill(student_model, iterator, optimizer, scheduler, criterion, teacher_model, model_config):
    student_model.train()
    teacher_model.eval()
    epoch_loss = 0
    distillation_loss = 0
...
if __name__ == '__main__':
    ...
    for epoch in trange(args.epochs, desc="Epoch"):
        train_loss, distill_loss, train_acc, wall_time = train_with_logit_distill(bert_student_model, train_dataloader,
                                                                                  optimizer, scheduler,

...
def train_with_hidden_distill(student_model, iterator, optimizer, scheduler, criterion, teacher_model, model_config,
                              layer_config):
    student_model.train()
    teacher_model.eval()
    epoch_loss = 0
    ...
    for i, batch in enumerate(iterator):
        ...
        full_loss = hidden_loss / (float(len(layer_config["student_to_teacher_layer"])))
...
if __name__ == '__main__':
    ...
    for epoch in trange(args.epochs, desc="Epoch"):
        train_loss, distill_loss, train_acc, wall_time = train_with_hidden_distill(bert_student_model, train_dataloader,
                                                                                   optimizer, scheduler,
